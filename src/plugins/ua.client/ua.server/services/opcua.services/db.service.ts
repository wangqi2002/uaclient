import {Errors, Sources, TableCreateModes, Warns} from '../../../common/ua.enums'
...
export module DbService {
    ...
    function initStmt(sqlChoose: string) {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorInitStmt, e.message, e.stack)
        }
    }
    ...
    export function insert(data: IDbData) {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorInsert, e.message, e.stack)
        }
    }
    ...
    export function createTable(tableName?: string, fieldNames?: IFieldNames) {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorCreatTable, e.message, e.stack)
        }
    }
    ...
    export function configDb(fileName: string, options: Database.Options) {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorConfigDb, e.message, e.stack)
        }
    }
    ...
    export function closeDb() {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorCloseDb, e.message, e.stack)
        }
    }
    ...
    export async function backUp(fileName: string) {
        try {
            ...
            throw new ClientError(Sources.dbService, Errors.errorBackUp, e.message, e.stack)
        }
    }
}